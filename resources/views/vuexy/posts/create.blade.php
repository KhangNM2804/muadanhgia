                        ...
                        <div class="row">
                            <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-switch custom-control-success custom-control-lg mb-2">
                                        <input type="checkbox" class="custom-control-input"
                                            id="example-sw-custom-success-lg1" name="is_comment" value="1"
                                            {{ old('is_comment', 0) == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-switch custom-control-success custom-control-lg mb-2">
                                        <input type="checkbox" class="custom-control-input"
                                            id="example-sw-custom-success-lg2" name="public" value="1"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-switch custom-control-success custom-control-lg mb-2">
                                        <input type="checkbox" class="custom-control-input"
                                            id="example-sw-custom-success-lg3" name="pin" value="1"
                                            {{ old('pin', 0) == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-switch custom-control-success custom-control-lg mb-2">
                                        <input type="checkbox" class="custom-control-input"
                                            id="example-sw-custom-success-lg4" name="coin_flg" value="1"
                                            {{ old('coin_flg', 0) == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="dm-post-add-title" name="valid_coin"
                                        value="{{ old('valid_coin', 0) }}" placeholder="">
                                </div>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary">
                            <i data-feather='plus-circle'></i> Tạo bài viết
                        </button>
                    </form>
                </div>
            </div>
