                                ...
                                <div class="col-sm-10 col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                            <input type="radio" class="custom-control-input" id="example-radio-custom-inline1" name="type" value="1" {{ (old('type',1) == 1)?"checked":"" }}>
                                            <label class="custom-control-label" for="example-radio-custom-inline1">Via</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                            <input type="radio" class="custom-control-input" id="example-radio-custom-inline2" name="type" value="2" {{ (old('type','') == 2)?"checked":"" }}>
                                            <label class="custom-control-label" for="example-radio-custom-inline2">Clone</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                            <input type="radio" class="custom-control-input"  id="example-radio-custom-inline3" name="type" value="3" {{ (old('type','') == 3)?"checked":"" }}>
                                            <label class="custom-control-label" for="example-radio-custom-inline3">BM</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                            <input type="radio" class="custom-control-input"  id="example-radio-custom-inline4" name="type" value="4" {{ (old('type','') == 4)?"checked":"" }}>
