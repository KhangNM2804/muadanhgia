            ...
            <div class="col-md-12">
                <div class="block block-themed">
                    <div class="block-header bg-gd-dusk">
                        <h3 class="block-title">Edit thể loại</h3>
                    </div>
                        ...
                        <div class="row py-sm-3 py-md-5">
                            ...
                            <div class="col-sm-10 col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="long_desc" class="form-control" rows="5">{{ old('long_desc',$getCate->long_desc) }}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" name="min_can_buy" placeholder="" value="{{ old('min_can_buy',$getCate->min_can_buy) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    @if (!empty($types))
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                            <input type="radio" class="custom-control-input" id="example-radio-custom-inline{{$item->id}}" name="type" value="{{$item->id}}" {{ (old('type',$getCate->type) == $item->id)?"checked":"" }}>
