...
@section('content')
    <main id="main-container">
        ...
        {{-- @include('elements.topmenu2') --}}

        <div class="content">
            @if (getSetting('display_product') && getSetting('display_product') == 'list')
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">{{ $types['name'] }}</small></h3>
                    </div>
                    <div class="block-content block-content-full">
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-full2">
                            ...
                            <tbody>
                                @if (!empty($types['listcate']))
                                    @foreach ($types['listcate'] as $item)
                                        @php
                                        ...
                                        <tr>
                                            <td class="text-left">
                                                @if (!empty($types['icon']))
                                                    <img src="{{ asset('assets/media/country/' . $types['icon']) }}"
                                            ...
                                            <td class="text-left">
                                                <span class="badge badge-primary">{{ $sell_count }} sản phẩm</span>
                                            </td>
                                            <td class="text-left">
                                                ...
                                                @else
                                                    <i class="font-w400" style="font-size: 0.77rem;"></i> <strong
                                                        class="text-danger">» {{ number_format($item->price) }}đ</strong>
                                                @endif
                                            </td>
                                            ...
                                            <td class="text-left">
                                                ...
                                                @else
                                                    <button class="btn btn-hero-primary px-4 buy-btn"
                                                        data-type-id="{{ $item->id }}" data-name="{{ $item->name }}"
            ...
            @else
                ...
                @if ($types)
                    @if (!checkEmptyType($types['id']))
                        <div class="block block-themed">
                            <div class="block-header bg-gd-dusk">
                                <h3 class="block-title">{{ $types['name'] }}</h3>
                            </div>
                                                    ...
                                                    <a class="block block-rounded block-bordered block-link-pop block-themed text-center clone-item item-custom"
                                                        ...
                                                        <div class="block-content bg-body-light pt-2">
                                                            <div class="py-2">
                                                                ...
                                                                <p class="h6 text-muted mb-1"><?= __('labels.remaning') ?>:
                                                                    <strong
        ...
        <div class="content">
            ...
            @if (empty(getSetting('list_transaction_flg')))
                <!-- Users and Purchases -->
                <div class="row row-deck">
                                        ...
                                        <div
                                            ...
                                            <b>
                                                ...
                                                <font color="red">Đã mua {{ $item->quantity }}
                                                    {{ $item->gettype->name }} -
                                                    {{ number_format($item->gettype->price) }} VNĐ</font>
                                            </b>
