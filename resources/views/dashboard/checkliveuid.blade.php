            ...
            <div class="col-12">
                <div class="block block-rounded block-themed block-fx-pop">
                    <div class="block-header bg-info">
                        <h3 class="block-title">Check Live UID Clone</h3>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row push">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <textarea wrap="off" class="form-control" id="listclone" name="example-textarea-input" rows="6" placeholder="<?= __('labels.enter_list_clone') ?>" style="font-size: 14px;"></textarea>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="row push">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <textarea wrap="off" class="form-control form-control-alt" id="listclonelive" name="example-textarea-input" rows="6" placeholder="<?= __('labels.no_result') ?>" style="font-size: 14px;"></textarea>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <textarea wrap="off" class="form-control form-control-alt is-invalid" id="listclonedie" name="example-textarea-input" rows="6" placeholder="<?= __('labels.no_result') ?>" style="font-size: 14px;"></textarea>
                                        </div>
                                        <div class="form-group">
