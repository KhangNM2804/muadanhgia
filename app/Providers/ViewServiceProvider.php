...
class ViewServiceProvider extends IlluminateViewServiceProvider
{
    ...
    public function registerViewFinder()
    {
        $this->app->bind('view.finder', function ($app) {
            $view_setting = getSetting('giaodien');
            if(!empty($view_setting)){
                $path_setting = [
                    resource_path('views/'.$view_setting)
                ];
            }
            return new FileViewFinder($app['files'], $path_setting ?? $app['config']['view.paths']);
        });
    }
